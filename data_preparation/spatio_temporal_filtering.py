import pandas as pd
from data_preparation import get_compressed_save_location, get_metadata, get_series, get_all_granularity_data
...
def read_bd_data_interval(start, end):
    metadata, series, metadata_region, region_series, metadata_country, country_series = read_bd_series()
